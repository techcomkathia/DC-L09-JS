...
function autenticacao(req, res, next) {
    ...
    const tokenDecodificado = JWT.verify(token, process.env.PALAVRA_SECRETA) //retorna true ou false
    //ou com o método decode que recebe o token e a palavra secreta e decodifica o token para um objeto, com o seu payload
    const conteudoToken = JWT.decode(token, process.env.PALAVRA_SECRETA)
